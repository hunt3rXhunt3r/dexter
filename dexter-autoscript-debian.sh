...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/IlhamArrouf/IlhamGanteng/master/sources.list.debian7"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/IlhamArrouf/IlhamGanteng/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by Muhamad Ilham Arrouf</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/IlhamArrouf/IlhamGanteng/master/vps.conf"
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/IlhamArrouf/IlhamGanteng/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/IlhamArrouf/IlhamGanteng/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/IlhamArrouf/IlhamGanteng/master/mrtg.conf" >> /etc/mrtg.cfg
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/IlhamArrouf/IlhamGanteng/master/squid3.conf"
